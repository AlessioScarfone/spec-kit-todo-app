...
- 002-subtask-count-badge: Added TypeScript 5.x, Node.js >= 22, `"type": "module"` (ES imports throughout) + `ink` v6, `@inkjs/ui` v2, `react`, `better-sqlite3` v9

- 001-tui-todo-app: Added TypeScript 5.x, Node.js >= 22, `"type": "module"` (ES imports throughout) + `ink` v6, `@inkjs/ui` v2, `react`, `better-sqlite3` v9, `env-paths`
