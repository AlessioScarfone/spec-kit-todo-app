...
export function TaskItem({ task, isSelected, isExpanded, hasSubtasks, subtaskCompleted = 0, subtaskTotal = 0 }: TaskItemProps) {
  ...
  return (
    <Box>
      ...
      <Text dimColor={isComplete}>
        ...
        {subtaskTotal > 0 && <Text dimColor> {subtaskCompleted}/{subtaskTotal}</Text>}
